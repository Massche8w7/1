...
API_TOKEN = '7063496302:AAGjFZKjzcEyg6WHYb1XaNJ2BoBCtAMxsX4'
bot = telebot.TeleBot(API_TOKEN)

@bot.message_handler(commands=['start'])
def send_welcome(message):
    bot.reply_to(message, "Welcome...!!\nTyep /cmd For Command")
    
@bot.message_handler(commands=['cmd'])
def send_welcome(message):
    bot.reply_to(message, "Command : /stp {cc}\nExp : /stp 5489320000xxxxxx|xx|xxxx|xxx")
...
def handle_card(message):
    ...
    if response.status_code == 200:
        ...
        if 'payment_id' in json_response:
            ...
            #)
            final_message = (f"━━━━━━━━━━━\nCard : {card}\n━━━━━━━━━━━\nGateway : Stripe Donation 1$\n━━━━━━━━━━━\nResponse :{stripe_response.text}\n━━━━━━━━━━━\nPayment Id : {payment_id}\n━━━━━━━━━━━\nTime : {elapsed_time:.2f} Sec.\nBot By : @NB_Luis\n━━━━━━━━━━━")
